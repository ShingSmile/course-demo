...
!!! example "方法1：通过 Snap 安装（推荐）"
    ...
    ```
    ![下载](https://cdn.jsdelivr.net/gh/zhiweinju/nju-dl-lab-2026spring@main/docs/lab1/pics/image-20250205175350133.png)
...
!!! example "4. 配置镜像源及NVIDIA容器工具包"
    ...
    # 1. 配置NVIDIA Container Toolkit 官方 GPG 密钥（新方法）
    ...
    # 5. 使用官方工具自动配置Docker运行时（替代手动修改daemon.json的运行时部分）
    sudo nvidia-ctk runtime configure --runtime=docker
    
    # 6. 配置Docker镜像加速器（保留你的配置）
    sudo mkdir -p /etc/docker
    # 注意：这里我们只写入镜像加速器，因为运行时已由上面命令自动配置好
    ...
    echo "NVIDIA Container Toolkit 安装和配置完成！"
    ```
...
!!! example "验证安装"
    ...
    ![image-20250205175224646](https://cdn.jsdelivr.net/gh/zhiweinju/nju-dl-lab-2026spring@main/docs/lab1/pics/image-20250205175224646.png)
...
!!! example "3. 连接容器"
    ...
    !!! warning "注意"
        ...
        ![vscode-docker-attach](https://cdn.jsdelivr.net/gh/zhiweinju/nju-dl-lab-2026spring@main/docs/lab1/pics/vserror.png)
...
!!! note "容器内操作"
    ...
    ![image-20250205175208931](https://cdn.jsdelivr.net/gh/zhiweinju/nju-dl-lab-2026spring@main/docs/lab1/pics/image-20250205175208931.png)
...
!!! note "实验材料"
    ...
    [下载练习代码](https://cdn.jsdelivr.net/gh/zhiweinju/nju-dl-lab-2026spring@main/docs/lab1/lab1.ipynb){ .md-button}
...
!!! example "方式二 在 VSCode 中使用（推荐）"
    1. **安装插件**：
       ![img](https://cdn.jsdelivr.net/gh/zhiweinju/nju-dl-lab-2026spring@main/docs/lab1/pics/0129965dd777b94539bb47d1500c088a.png)
    2. **选择Python环境**：
       在右上角可以选择我们之前安装好的python环境(pytorch)
       ![img](https://cdn.jsdelivr.net/gh/zhiweinju/nju-dl-lab-2026spring@main/docs/lab1/pics/selectenv.png)

        ???note "vscode jupyter 选择环境下载插件"
            1.选择下载插件

            ![img](https://cdn.jsdelivr.net/gh/zhiweinju/nju-dl-lab-2026spring@main/docs/lab1/pics/extesion.png)

            2.运行单元格时，出现需要下载ipykernel环境，选择yes(或者自行安装ipykernel)

            ![img](https://cdn.jsdelivr.net/gh/zhiweinju/nju-dl-lab-2026spring@main/docs/lab1/pics/clipyes.png)
