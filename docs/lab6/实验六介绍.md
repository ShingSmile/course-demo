...
[下载任务一代码](https://cdn.jsdelivr.net/gh/zhiweinju/nju-dl-lab-2026spring@main/docs/lab6/EXP1_GAN.ipynb){ .md-button}
...
[下载任务二代码](https://cdn.jsdelivr.net/gh/zhiweinju/nju-dl-lab-2026spring@main/docs/lab6/EXP2_DCGAN.ipynb){ .md-button}
...
[下载任务三代码](https://cdn.jsdelivr.net/gh/zhiweinju/nju-dl-lab-2026spring@main/docs/lab6/EXP3_WGAN.ipynb){ .md-button}
